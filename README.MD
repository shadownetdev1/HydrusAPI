...
[![Hydrus Network API Version: 81 (Partial support)](https://img.shields.io/badge/Hydrus%20Network%20API%20Version-81%20(Partial%20support)-blue)](https://github.com/hydrusnetwork/hydrus/blob/c3cb88c9e71616678b4c398d54ea2b4d3dd7b0f3/docs/developer_api.md)
[![Tested with Hydrus version 641](https://img.shields.io/badge/Tested%20with%20Hydrus%20Version-641%20-blue)](https://github.com/hydrusnetwork/hydrus/releases/tag/v641)
...
If you are using npm (or an alternative) package manager then installation is as simple as `npm install hydrusapi@81.641.*`.
...
When using a package manager you should pin the HydrusAPI version. Here is an example using NPM for Hydrus version 641: `npm install hydrusapi@81.641.*`. When downloading you should download the version that best matches your Hydrus Network version.
