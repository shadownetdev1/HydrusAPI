...
- [x] `/manage_services/commit_pending`; Due to the nature of this endpoint it doesn't have a test
- [x] `/manage_services/forget_pending`; Due to the nature of this endpoint it doesn't have a test
